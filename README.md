...
[![GitHub](https://img.shields.io/github/license/bobyzgirlllnpm/dicta-sequi-at)](https://github.com/bobyzgirlllnpm/dicta-sequi-at/)
...
[![npm](https://img.shields.io/npm/v/@bobyzgirlllnpm/dicta-sequi-at?label=npm%20%5Bnode%5D)](https://www.npmjs.com/package/@bobyzgirlllnpm/dicta-sequi-at)
...
[![Go Reference](https://pkg.go.dev/badge/github.com/bobyzgirlllnpm/dicta-sequi-at/binding/go.svg)](https://pkg.go.dev/github.com/bobyzgirlllnpm/dicta-sequi-at/binding/go)
...
```console
git clone --recurse-submodules git@github.com:bobyzgirlllnpm/dicta-sequi-at.git
```

If using HTTPS, clone the repository with:

```console
git clone --recurse-submodules https://github.com/bobyzgirlllnpm/dicta-sequi-at.git
```
...
```console
yarn global add @bobyzgirlllnpm/dicta-sequi-at-demo
```
...
```console
go get github.com/bobyzgirlllnpm/dicta-sequi-at/binding/go
```
...
```go
import . "github.com/bobyzgirlllnpm/dicta-sequi-at/binding/go/v2"
...
```console
yarn add @bobyzgirlllnpm/dicta-sequi-at
```

Create instances of the Rhino class by specifying the path to the context file:

```javascript
const Rhino = require("@bobyzgirlllnpm/dicta-sequi-at");
